...
object Dependencies {
  ...
  lazy val mockito: ModuleID = "org.mockito" % "mockito-core" % "5.3.0" % Test
  ...
  lazy val testContainers: ModuleID = "com.dimafeng" %% "testcontainers-scala-scalatest" % "0.40.14" % Test
